module bus_interface(
    ...
    //always_comb begin
    //    case (ioaddr)
    //        2'b00: databus = (~iorw | rda) ? rec_buffer : 8'bz; //either writing data or reading data
    //        2'b10: databus = rec_buffer;    //sending low byte
    //        2'b11: databus = rec_buffer;    //sending high byte
    //        default: databus = 8'bz; 
    //    endcase
    //end
